...
Außerdem gibt es die Option "-reload", bei der die HTML-Seite eines Tages neu berechnet wird. Die Eingabe erfolgt dabei nach dem Schema "-reload <Jahr> <Monat> <Tag>", also z.B. "-reload 2015 12 1" (für den 1. Dezember). Wenn anstatt des Datums "all" angegeben wird, werden alle Dateien neu berechnet.
